...
class Character
	...
	def initialize(args)
		...
		@job_purpose = ["repair","build","design","sell","study"].sample + " " + ["chairs", "cars", "computers", "gloves", "pants", "shirts", "tables", "shoes", "hats", "plates", "knifes", "bottles", "coats", "lamps", "keyboards", "bags", "benches", "clocks", "watches", "wallets"].sample
